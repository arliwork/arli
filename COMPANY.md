...
1. **ARLI Core** - Platform for autonomous AI companies
   - Status: In Progress
...
- `fix-bug` → backend-dev investigates → frontend-dev fixes UI → qa validates → devops deploys
- `refactor` → architect designs → backend-dev executes → devops monitors
