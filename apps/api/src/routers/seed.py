...
async def seed_welcome(
    ...
    logs = [
        ActivityLog(
            ...
            event_description="Q2 roadmap planning and resource allocation",
        ...
        ActivityLog(
            ...
            event_type="completed_task",
            event_description="Closed enterprise deal with Acme Corp ($5,400 ARR)",
        ...
        ActivityLog(
            ...
            actor_name=dev.name,
            event_type="completed_task",
            event_description="Built NFT minting integration with ICP blockchain",
        ...
        ActivityLog(
            ...
            event_description="Implement real-time WebSocket dashboard",
            event_metadata={},
        ),
        ActivityLog(
            actor_type="user",
            ...
            event_description="Created Alpha CEO agent",
